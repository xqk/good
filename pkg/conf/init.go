...
func init() {
	...
	flag.Register(&flag.StringFlag{Name: "config-namespace", Usage: "--config-namespace=good, 配置内建组件的默认命名空间, 默认是good", Default: "good", Action: func(key string, fs *flag.FlagSet) {
