...
func (u *URL) QueryInt(field string, expect int) (ret int) {
	ret, err := icast.ToIntE(u.Query().Get(field))
	if err != nil {
		return expect
	}
...
func (u *URL) QueryInt64(field string, expect int64) (ret int64) {
	ret, err := icast.ToInt64E(u.Query().Get(field))
	if err != nil {
		return expect
	}
...
func (u *URL) QueryDuration(field string, expect time.Duration) (ret time.Duration) {
	ret, err := icast.ToDurationE(u.Query().Get(field))
	if err != nil {
		return expect
	}
...
func (u *URL) QueryBool(field string, expect bool) (ret bool) {
	ret, err := icast.ToBoolE(u.Query().Get(field))
	if err != nil {
		return expect
	}
	return ret
