...
func TestNewEndpoint(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{"https", "github.com/xqk/good/", false},
			want: &url.URL{Scheme: "https", Host: "github.com/xqk/good/"},
		},
		{
...
func TestParseEndpoint(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:    "kratos",
			args:    args{endpoints: []string{"https://github.com/xqk/good?isSecure=true"}, scheme: "https", isSecure: true},
			want:    "github.com",
			wantErr: false,
		},
		{
